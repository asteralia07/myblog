    ...
    <section id="profile" className="pt-20 md:pt-32 pb-12 md:pb-20 px-4 md:px-6 relative" ref={ref}>
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-16 items-center mb-12 md:mb-20">
          ...
          >
            <div className="relative inline-block group">
              ...
              <div className="absolute -inset-2 md:-inset-4 bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 rounded-full blur-lg opacity-30 group-hover:opacity-50 transition-all duration-500 animate-pulse"></div>

              {/* Rotating Border - Smaller on mobile */}
              <div className="absolute -inset-1 md:-inset-2 bg-gradient-to-r from-blue-500 via-indigo-500 to-cyan-500 rounded-full animate-spin-slow opacity-75"></div>

              {/* Inner Border */}
              <div className="absolute -inset-0.5 md:-inset-1 bg-gradient-to-r from-white to-blue-50 dark:from-slate-800 dark:to-blue-900 rounded-full"></div>

              {/* Profile Image Container - Responsive sizing */}
              <div className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-full overflow-hidden border-2 md:border-4 border-white dark:border-slate-800 shadow-2xl group-hover:scale-105 transition-all duration-500">
                <Image
                ...
                {/* Hover Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-blue-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
              </div>
              ...
              <div className="absolute -bottom-2 -right-2 md:-bottom-4 md:-right-4 flex space-x-1 md:space-x-2">
                <div className="w-6 h-6 md:w-8 md:h-8 bg-gradient-to-r from-blue-400 to-cyan-500 rounded-full border-2 md:border-4 border-white dark:border-slate-800 flex items-center justify-center shadow-lg animate-bounce-slow">
                  <div className="w-2 h-2 md:w-3 md:h-3 bg-white rounded-full animate-pulse"></div>
                </div>
                <div className="w-6 h-6 md:w-8 md:h-8 bg-gradient-to-r from-indigo-400 to-blue-500 rounded-full border-2 md:border-4 border-white dark:border-slate-800 flex items-center justify-center shadow-lg animate-bounce-slow delay-200">
                  <Zap className="w-3 h-3 md:w-4 md:h-4 text-white" />
                </div>
              </div>

              {/* Floating Icons - Responsive sizing and positioning */}
              <div className="absolute -top-3 -left-3 md:-top-6 md:-left-6 w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full flex items-center justify-center shadow-lg animate-float">
                <Sparkles className="w-4 h-4 md:w-5 md:h-5 text-white" />
              </div>
              <div className="absolute -top-2 -right-4 md:-top-4 md:-right-8 w-6 h-6 md:w-8 md:h-8 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full flex items-center justify-center shadow-lg animate-float delay-1000">
          ...
          >
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-2 sm:space-y-0 sm:space-x-4 mb-4 md:mb-6">
                <div className="h-px bg-gradient-to-r from-blue-500 to-transparent w-16 md:w-20 animate-expand hidden sm:block"></div>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-600 dark:text-slate-300 leading-relaxed mb-6 md:mb-10 font-light animate-fade-in-up delay-700 px-4 lg:px-0">
                ...
                with{" "}
                <span className="font-semibold bg-gradient-to-r from-indigo-600 to-cyan-600 bg-clip-text text-transparent">
                  functionality
                </span>
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 md:gap-6 animate-fade-in-up delay-900 px-4 lg:px-0">
                <Button
                  size="lg"
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8 max-w-4xl mx-auto px-4">
