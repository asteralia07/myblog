  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-slate-950 dark:via-blue-950 dark:to-slate-900 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 md:w-96 md:h-96 bg-gradient-to-r from-blue-400/10 to-indigo-600/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-gradient-to-r from-cyan-400/10 to-blue-600/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 w-48 h-48 md:w-64 md:h-64 bg-gradient-to-r from-indigo-400/5 to-blue-600/5 rounded-full blur-2xl animate-pulse delay-500"></div>
        ...
        <div className="absolute top-20 left-20 w-1 h-1 md:w-2 md:h-2 bg-blue-500 rounded-full animate-ping"></div>
        <div className="absolute top-40 right-32 w-0.5 h-0.5 md:w-1 md:h-1 bg-indigo-500 rounded-full animate-pulse delay-500"></div>
        <div className="absolute bottom-32 left-1/3 w-1 h-1 md:w-1.5 md:h-1.5 bg-cyan-500 rounded-full animate-bounce delay-1000"></div>
      </div>
